...
DEVICE_MAC = "69:33:44:69"

CONTROL_TOPIC = (
    f"{DEVICE_MAC}/subscriber/"
    "tasks=Humidity,Temperature,ThermalCamera;"
    "Max_Latency=300,250,300;Accuracy=88,90,88;Min_Frequency=5,6,.11;"
)

CSV_PATH = Path("power_log4.csv")
